...
<p class='body-text'>
 Write a paragraph here detailing that the article is over. Mention stuff that you've learned. 
 Mention stuff that's related that we didn't mention. You only need edit the next two paragraphs
 slightly.
 </p>
 <br>
 <p class="body-text">
 ...
 away with a better understanding of some of the difficulties of 
 ...
 <a class="on-end" href="https://twitter.com/jdwlbr">directly</a>. The
