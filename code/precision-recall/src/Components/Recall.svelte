...
<h1 class="body-header">ROC & AUC</h1>
<p class="body-text">
 This component is a scope example of a D3 chart. It's pretty simple.
</p>
<p class="body-text">
 The F1-score combines the precision and recall of a classifier into a single
 metric by taking their harmonic mean. It is primarily used to compare the
 performance of two classifiers. Suppose that classifier A has a higher recall,
 and classifier B has higher precision. In this case, the F1-scores for both
 the classifiers can be used to determine which one produces better results.
